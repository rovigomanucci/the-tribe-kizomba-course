...
Students complete a social dance using clear walking, basic direction changes, core Kizomba vocabulary, and simple musical decisions.

## Eight-week map

| Week | Class | Main move family | Hidden foundation |
|---:|---|---|---|
| 1 | Your First Kizomba Flow | Marca, Basic 1, Basic 2 | Pulse, posture, full weight transfer |
| 2 | The Kizomba Walk | Basic 3 and natural walking | Torso-led direction and stopping |
...
A student is ready for Level 2 when they demonstrate:
...
- Comfortable closed or semi-open connection
- Basic timing awareness without constant teacher counting
