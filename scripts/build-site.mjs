...
<div class="app">
  <header class="topbar">
    ...
    <div class="top-actions"><button class="ghost search-label" id="searchButton">⌕ Search</button><button class="ghost print" onclick="window.print()">Print</button></div>
  </header>
  <div class="layout">
