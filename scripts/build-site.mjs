...
const videos={
"l1w1":[{block:3,title:"Kizomba Basic 2, Armand & Lavinia",id:"wB1sArnmxTs",note:"Core Basic 2 reference."},{block:4,title:"Kizomba Basic 1, Armand & Lavinia",id:"Na-FuvqCOQw",note:"Core Basic 1 reference."}],
"l1w2":[{block:3,title:"Kizomba Walk, Armand & Lavinia",id:"MPqGx1etT5k",note:"Use alongside the Tribe stop and restart drill."}],
"l1w3":[{block:4,title:"Clockwise rotation, Armand & Lavinia",id:"XXweA-Y3uUc",note:"Keep travel compact for social floorcraft."}],
"l1w4":[{block:4,title:"Kizomba Tutorial 08, Saída Men",id:"sMkZoVaFB7k",note:"Leader's Saída instructor reference."}],
"l1w5":[{block:4,title:"Get Started with Kizomba Right Now",id:"jXGfTwais88",note:"Start at 2:01 for the follower's Saída section."}],
"l1w6":[{block:1,title:"Improve Your Kizomba in 10 Days, Day 7, ChaCha",id:"GW3p9Q-4ipw",note:"Core rhythm and weight-transfer reference."},{block:5,title:"Follower's Saída, lateral cha-cha, Leader's Saída",id:"CpqlxeEQySs",note:"Applied reference for the Saída entry and clean exit."}],
"l1w7":[{block:4,title:"Vírgula and Retrocesso, Armand & Lavinia",id:"bXoJqx4CIsk",note:"Use the compact, body-led version only."}],
"l1w8":[{block:3,title:"How to Dance During Kizomba Breaks",id:"WG3vC4XH-yE",note:"Start at 1:30 for the first pause example."}]
};
...
function renderVideos(lesson){const references=videos[lesson.id]||[];if(!references.length)return'';return '<details class="video-library" open><summary class="video-library-summary"><span><span class="eyebrow">Reference videos</span><h3>Watch before teaching this week</h3></span><span class="video-count">'+references.length+' video'+(references.length===1?'':'s')+' · Hide/Show</span></summary><div class="video-library-grid">'+references.map(videoEmbed).join('')+'</div></details>'}
