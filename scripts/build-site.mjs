...
<script>try{document.documentElement.dataset.theme=localStorage.getItem('tribe-kizomba-theme')||'dark'}catch(error){document.documentElement.dataset.theme='dark'}</script>
<style>
